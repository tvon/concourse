...
type FakeResourceType struct {
	...
	SetResourceConfigStub        func(atc.Source, creds.VersionedResourceTypes) (db.ResourceConfigScope, error)
	setResourceConfigMutex       sync.RWMutex
	setResourceConfigArgsForCall []struct {
		arg1 atc.Source
		arg2 creds.VersionedResourceTypes
	}
...
func (fake *FakeResourceType) SetResourceConfig(arg1 atc.Source, arg2 creds.VersionedResourceTypes) (db.ResourceConfigScope, error) {
...
func (fake *FakeResourceType) SetResourceConfigCalls(stub func(atc.Source, creds.VersionedResourceTypes) (db.ResourceConfigScope, error)) {
	fake.setResourceConfigMutex.Lock()
	defer fake.setResourceConfigMutex.Unlock()
	fake.SetResourceConfigStub = stub
}

func (fake *FakeResourceType) SetResourceConfigArgsForCall(i int) (atc.Source, creds.VersionedResourceTypes) {
	fake.setResourceConfigMutex.RLock()
	defer fake.setResourceConfigMutex.RUnlock()
