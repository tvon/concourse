...
type ResourceType interface {
	...
	SetResourceConfig(atc.Source, creds.VersionedResourceTypes) (ResourceConfigScope, error)
...
func (t *resourceType) SetResourceConfig(source atc.Source, resourceTypes creds.VersionedResourceTypes) (ResourceConfigScope, error) {
