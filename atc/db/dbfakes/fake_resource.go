...
func (fake *FakeResource) SetResourceConfig(arg1 atc.Source, arg2 creds.VersionedResourceTypes) (db.ResourceConfigScope, error) {
...
func (fake *FakeResource) SetResourceConfigCalls(stub func(atc.Source, creds.VersionedResourceTypes) (db.ResourceConfigScope, error)) {
	fake.setResourceConfigMutex.Lock()
	defer fake.setResourceConfigMutex.Unlock()
	fake.SetResourceConfigStub = stub
}

func (fake *FakeResource) SetResourceConfigArgsForCall(i int) (atc.Source, creds.VersionedResourceTypes) {
	fake.setResourceConfigMutex.RLock()
	defer fake.setResourceConfigMutex.RUnlock()
