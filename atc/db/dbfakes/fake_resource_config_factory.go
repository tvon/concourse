...
type FakeResourceConfigFactory struct {
	...
	FindOrCreateResourceConfigStub        func(string, atc.Source, creds.VersionedResourceTypes) (db.ResourceConfig, error)
...
func (fake *FakeResourceConfigFactory) FindOrCreateResourceConfig(arg1 string, arg2 atc.Source, arg3 creds.VersionedResourceTypes) (db.ResourceConfig, error) {
...
func (fake *FakeResourceConfigFactory) FindOrCreateResourceConfigCalls(stub func(string, atc.Source, creds.VersionedResourceTypes) (db.ResourceConfig, error)) {
	fake.findOrCreateResourceConfigMutex.Lock()
	defer fake.findOrCreateResourceConfigMutex.Unlock()
	fake.FindOrCreateResourceConfigStub = stub
}

func (fake *FakeResourceConfigFactory) FindOrCreateResourceConfigArgsForCall(i int) (string, atc.Source, creds.VersionedResourceTypes) {
	fake.findOrCreateResourceConfigMutex.RLock()
	defer fake.findOrCreateResourceConfigMutex.RUnlock()
